...
const Cart = ({history}) => {
    ...
    return(
        ...
        <div className="container-fluid mt-4 my-5" style={{display:"flex", flexDirection:"column",alignItems:"center"}}>
            ...
            <div className="container-fuild p-1 px-2 cartItems_container"style={{display:"flex", flexDirection:"column",alignItems:"center", minWidth:"280px", width:"100%", height:"61.8vh", overflow:"auto"}} >
            {cartItems && 
